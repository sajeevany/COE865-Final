...
public class RoutingTableEntry {
    ...
    private HashMap<String, String> neighbourAndResource = new HashMap<>();
    ...
    public String hasResource(String resource) { //Returns the uniqueID of the client with the associated resource.
        String id = "";
    ...
    public String toString() {
        return "RoutingTableEntry{" + "nextHop=" + nextHop + ", nextHopSocket=" + nextHopSocket + ", uniqueID=" + uniqueID + ", neighbourAndResource=" + neighbourAndResource.toString() + '}';
    }
}
